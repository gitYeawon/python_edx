...
input_test = input("enter somethings eaten in last 24hrs: ").lower()

# [ ] print "True" message if "dairy" is in the input or False message if not
one = ("dairy" in input_test)
print("It is ", one , "that '", input_test ,"'contains 'dairy'")

# [ ] print True message if "nuts" is in the input or False if not
two = ("nuts" in input_test)
print("It is ", two , "that '", input_test ,"'contains 'nuts'")

# [ ] Challenge: Check if "seafood" is in the input - print message
three = ("seafood" in input_test)
print("It is ", three , "that '", input_test ,"'contains 'seafood'")

# [ ] Challenge: Check if "chocolate" is in the input - print message
four = ("chocolate" in input_test)
print("It is ", four , "that '", input_test ,"'contains 'chocolate'")
